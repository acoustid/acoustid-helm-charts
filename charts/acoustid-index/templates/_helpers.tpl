...
{{ include "acoustid-index.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "acoustid-index.selectorLabels" -}}
...
*/}}
{{- define "acoustid-index.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "acoustid-index.fullname" .) .Values.serviceAccount.name }}
{{- else }}
